...
(defcustom fortune-prg "/usr/texbin/fortune"
  "Program for `insert-fortune' and `insert-cowsay-fortune'")

(defcustom fortune-data-dir "/opt/local/share/games/fortune"
  "Data dir storing fortunes cookies")

(defcustom cowsay-prg "/usr/texbin/cowsay"
...
(defcustom cowsay-data-dir "/opt/local/share/cowsay/cows"
...
(defun fortune-idle-start ()
  ...
  (interactive)
  (unless (file-executable-p fortune-prg)
